...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Ume",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC3Ume24AISettingsViewController")
@interface AISettingsViewController : NSViewController <NSTextFieldDelegate>
- (void)loadView;
- (void)controlTextDidEndEditing:(NSNotification * _Nonnull)notification;
...
@class NSWindow;
SWIFT_CLASS("_TtC3Ume21AboutWindowController")
...
@class NSApplication;
SWIFT_CLASS("_TtC3Ume11AppDelegate")
...
SWIFT_CLASS("_TtC3Ume29GeneralSettingsViewController")
...
SWIFT_CLASS("_TtC3Ume23PrivacyWindowController")
...
@class NSTableColumn;
@class NSView;
SWIFT_CLASS("_TtC3Ume23SavedDataViewController")
@interface SavedDataViewController : NSViewController <NSTableViewDataSource, NSTableViewDelegate, NSTextFieldDelegate>
- (void)loadView;
...
SWIFT_CLASS("_TtC3Ume25SettingsTabViewController")
